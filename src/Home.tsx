                ...
                <div className="tw-flex tw-flex-1 tw-flex-col-reverse md:tw-flex-row tw-mx-auto tw-gap-8 tw-justify-between">
                  <div className="tw-flex tw-flex-col tw-gap-4 tw-flex-grow md:tw-max-w-[40%]">
                      ...
                      <div className="tw-flex tw-items-center tw-gap-2">
                        ...
                        >
                          <a
                            target="_blank"
                            rel="noopener noreferrer"
                             href="https://discord.com/channels/944423001577906176/944428187641868338"
                          >
                            <img
                        ...
                        >
                          <a
                            target="_blank"
                            rel="noopener noreferrer"
                            href="https://twitter.com/PlanetariansNFT"
                          >
                            <img
                    ...
                    <p className="tw-mb-4 tw-text-gray-light">
                                                        The Planetarians are a talented group of 1,555
                                                        explorers and technologists embarking on
                                                        dangerous intergalactic expeditions in search for
                                                        $ORB
                    </p>
                  ...
                  <div className="tw-flex tw-flex-1 tw-flex-col md:tw-flex-row tw-mx-auto tw-gap-32 tw-pb-20 tw-justify-between">
                    <div className="tw-flex tw-flex-col tw-gap-4 tw-flex-grow md:tw-w-[40%]">
                      ...
                      <div className="tw-flex tw-flex-wrap tw-gap-4">
                        ...
                        <a
                          href="https://discord.com/invite/planetarians"
                          target="_blank"
                          rel="noreferrer noopener"
                          className="tw-border tw-border-solid tw-border-purple-1 tw-flex tw-items-center tw-gap-2 tw-w-fit tw-rounded-full tw-px-2.5 tw-py-1.5 tw-text-white-2"
                        >
                      ...
                      <div>
                        ...
                        <p className="tw-text-gray-light tw-mb-3 tw-text-[16] tx-line-[24]">
                                                                The Planetarians are a collection of space
                                                                explorers and technologists embarking on
                                                                dangerous intergalactic expeditions on the
                                                                Solana blockchain. Each Planterian is one of a
                                                                kind with Planetarians spanning species from
                                                                across the Cosmos including: Humans, Aliens,
                                                                Cyborgs, Reptilians and the mystical Celestials.

                                                                Planetarian NFT holders will be able to embark
                                                                on expeditions and voyages across the cosmos
                                                                in search for $ORB. This prized token is the
                                                                foundation of the Planetarians ecosystem. Only
                                                                the most dedicated and adventurous explorers
                                                                will be able to mint a Planetarian companion. An
                                                                exclusive generation 2 mint with a limited supply
                                                                of 999 only minted with $ORB. Planetarians will
                                                                be able to play the Planetarians Wheel for more
                                                                exclusive rewards. A simple but addictive game
                                                                with a token burn mechanism. Using $ORB on
                                                                the wheel offers additional benefits for players
                                                                including chance of winning NFT’s giveaways,
                                                                premium whitelists and even legendary 1 of 1
                                                                Planetarian NFT’s.

                                                                There is much yet to be discovered in the
                                                                Planetarian universe. The Planetarians must
                                                                continue navigating through the most dangerous
                                                                and uncharted areas of the outer cosmos, for
                                                                they are bound in their quest for exploration,
                    ...
                    <div className="tw-flex tw-flex-col tw-gap-4 tw-flex-grow md:tw-w-[50%]">
                      ...
                      <div className="tw-p-4">
                        <div className="tw-p-4">
                          ...
                          <div className="tw-my-1">
                            <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                        1,555 Planetarians land on the Solana Blockchain


                                                                        Secondary market listing immediately on Magic Eden


                                                                        Rarity reveal


                                                                        Establish treasury with 20% mint proceeds and 30% royalties


                                                                        Planetarian holder verification
                            </p>
                            <br />
                          </div>
                          <div className="tw-my-1">
                            <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                        Sales bot (twitter/discord)
                            </p>
                            <br />
                          </div>
                          <div className="tw-my-1">
                            <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                        Begin air dropping $ORB to Planetarian holders
                            </p>
                            <br />
                          </div>
                          <div className="tw-my-1">
                          ...
                          <div className="tw-my-1">
                            <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                        Custom staking platform allowing Planetarians to go on expeditions and voyages for additional $ORB rewards


                                                                        Community development


                                                                        Alpha calls and giveaway collabs with partner projects
                            </p>
                            <br />
                          </div>
                          <div className="tw-my-1">
                            <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                        Legendary 1 of 1 Planetarian auctions
                            </p>
                            <br />
                          </div>
                          <div className="tw-my-1">
                            <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                        Mint 999 Planetarian companions exclusively using $ORB
                            </p>
                            <br />
                          </div>
                          <div className="tw-my-1">
                          ...
                          <div className="tw-my-1">
                            <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                        Test your luck on Planetarians decentralized wheel game powered by $ORB


                                                                        Introduce additional rewards for the game
                            </p>
                            <br />
                          </div>
                          <div className="tw-my-1">
                            <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                        Further brand development and marketing
                            </p>
                            <br />
                          </div>
                          <div className="tw-my-1">
